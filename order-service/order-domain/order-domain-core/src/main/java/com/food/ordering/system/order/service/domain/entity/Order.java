...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void initCancel(List<String> failureMessages) {
        ...
        updateFailureMessages(failureMessages.stream().filter(messages -> !messages.isEmpty()).toList());
    }
    ...
    private void validateItemsPrice() {
        Money allItemsTotal = items.stream().map(orderItem -> {
